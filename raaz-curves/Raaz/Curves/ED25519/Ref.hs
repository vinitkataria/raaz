...
module Raaz.Curves.ED25519.Ref
...
import Raaz.Curves.ED25519.Type ( Sign(..) )

-- | Compresses one block.
sha512CompressSingle :: Sign
                     -> CryptoPtr
                     -> IO Sign
...
-- | The sigle round of Sign
sha512round :: Sign
            -> BE Word64 -> BE Word64 -> BE Word64 -> BE Word64
            -> BE Word64 -> BE Word64 -> BE Word64 -> BE Word64
            -> BE Word64 -> BE Word64 -> BE Word64 -> BE Word64
            -> BE Word64 -> BE Word64 -> BE Word64 -> BE Word64
            -> Sign
sha512round h0 w0 w1 w2 w3 w4 w5 w6 w7 w8
          w9 w10 w11 w12 w13 w14 w15 = addHash h0 h80
            where
              sigS0,sigS1 :: BE Word64 -> BE Word64
              ...
              addHash :: Sign -> Sign -> Sign
              addHash (Sign v) (Sign v') =
                  Sign $ VU.zipWith (+) v v'

trans :: Int -> Sign -> BE Word64 -> Sign
trans r (Sign v) w' = Sign v'
  where
    sigB0,sigB1 :: BE Word64 -> BE Word64
